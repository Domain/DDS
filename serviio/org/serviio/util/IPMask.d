  ...
  public static byte[] textToNumericFormatV4(String src)
  {
    ...
    try
    {
      ...
      case 1: 
        ...
        res[0] = ((byte)(int)(val >> 24 & 0xFF));
        res[1] = ((byte)(int)((val & 0xFFFFFF) >> 16 & 0xFF));
        res[2] = ((byte)(int)((val & 0xFFFF) >> 8 & 0xFF));
        res[3] = ((byte)(int)(val & 0xFF));
        break;
      case 2: 
        ...
        res[0] = ((byte)(int)(val & 0xFF));
        val = Integer.parseInt(s[1]);
        if ((val < 0L) || (val > 16777215L)) {
          return null;
        }
        res[1] = ((byte)(int)(val >> 16 & 0xFF));
        res[2] = ((byte)(int)((val & 0xFFFF) >> 8 & 0xFF));
        res[3] = ((byte)(int)(val & 0xFF));
        break;
      case 3: 
        for (int i = 0; i < 2; i++)
        {
          ...
          res[i] = ((byte)(int)(val & 0xFF));
        }
        val = Integer.parseInt(s[2]);
        if ((val < 0L) || (val > 65535L)) {
          return null;
        }
        res[2] = ((byte)(int)(val >> 8 & 0xFF));
        res[3] = ((byte)(int)(val & 0xFF));
        break;
      case 4: 
        for (int i = 0; i < 4; i++)
