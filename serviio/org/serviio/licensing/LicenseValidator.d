...
public class LicenseValidator
{
  ...
  {
    String customerLicensebody = this.customerLicenseProvider.readLicense();
  ...
  private Tupple!(License, Long) validateLicense(String licenseBody)
  {
    if (licenseBody !is null)
    {
      ...
      try
      {
        ...
        Validator v = new Validator(l, "");
        v.addPlugin(new VersionValidatorPlugin());
        v.setIgnoreFloatTime(this.ignoreFloatTime);
        v.validate();
        Long remainingMillis = v.getTimeRemaining(new Date());
        return new Tupple(l, remainingMillis);
      }
      catch (IOException e)
      {
  ...
  private ServiioLicense validateBundledLicense()
  {
    try
    {
      Tupple!(License, Long) bundledLicense = validateLicense(this.bundledLicenseProvider.readLicense());
  ...
  private ServiioLicense buildServiioLicense(Tupple!(License, Long) license)
  {
    ...
    String version = lic.getProperty(LicenseProperties.VERSION.getName());
    ...
    return new ServiioLicense(id, edition, type, name, email, version, cast(Long)license.getValueB());
  }
