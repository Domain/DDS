...
public class Device
{
    ...
    private this()
    {
        ...
        log.info(String_format("Created UPnP Device with UUID: %s, bound address: %s", cast(Object[])[ uuid, bindAddress.getHostAddress() ]));
    }
    ...
    public void refreshBoundIPAddress() {
        bindAddress = (new LocalAddressResolverStrategy()).getHostIpAddress();
        log.info(String_format("Updated bound IP address of Device with UUID: %s, bound address: %s", cast(Object[])[ uuid, bindAddress.getHostAddress() ]));
    }
