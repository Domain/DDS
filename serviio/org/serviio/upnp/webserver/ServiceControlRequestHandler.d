...
public class ServiceControlRequestHandler : AbstractRequestHandler
{
    ...
    override protected void handleRequest(HttpRequest request, HttpResponse response, HttpContext context)
    {
        ...
        this.log.debug_(java.lang.String.format("ServiceControl request received for action '%s' from %s", cast(Object[])[ soapAction, clientIPAddress.getHostAddress() ]));
        if (( cast(HttpEntityEnclosingRequest)request !is null ))
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    StringEntity content = new StringEntity(outputStream.toString("UTF-8"), "UTF-8");
                    content.setContentType("text/xml; charset=\"utf-8\"");
            ...
            {
                this.log.error(java.lang.String.format("Cannot process control request: %s", cast(Object[])[ e.getMessage() ]), e);
                response.setStatusCode(500);
            }
        }
        else
