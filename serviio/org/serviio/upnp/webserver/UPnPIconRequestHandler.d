...
{
    public static const String LARGE_PNG = "largePNG";
    public static const String SMALL_PNG = "smallPNG";
    public static const String LARGE_JPG = "largeJPG";
    public static const String SMALL_JPG = "smallJPG";
    private static immutable Map!(String, IconDescription) icons;
    ...
    static this()
    {
        icons = new HashMap!(String, IconDescription)();
        try
        {
