...
public class ActionNode : ContainerNode
{
    ...
    override public BrowseItemsHolder!(DirectoryObject) retrieveContainerItems(String containerId, ObjectType objectType, int startIndex, int count, Profile rendererProfile, AccessGroup userProfile)
    {
        if (count == 0) {
            count = 2147483647;
        }
    ...
    override public int retrieveContainerItemsCount(String containerId, ObjectType objectType, AccessGroup userProfile)
    {
        if (recursive)
        {
