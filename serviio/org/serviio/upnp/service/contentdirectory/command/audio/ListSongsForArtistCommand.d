...
public class ListSongsForArtistCommand
  : AbstractSongsRetrievalCommand
{
  ...
  {
    List!(MusicTrack) songs = AudioService.getListOfSongsForArtist(new Long(getInternalObjectId()), this.accessGroup, this.startIndex, this.count);
    return songs;
  }
  
  public int retrieveItemCount()
  {
    return AudioService.getNumberOfSongsForArtist(new Long(getInternalObjectId()), this.accessGroup);
  }
}
