module org.serviio.upnp.service.contentdirectory.command.audio.ListSongsForPlaylistCommand;
...
public class ListSongsForPlaylistCommand : AbstractSongsRetrievalCommand
{
    ...
    {
        List!(MusicTrack) songs = AudioService.getListOfSongsForPlaylist(new Long(getInternalObjectId()), this.accessGroup, this.startIndex, this.count);
        return songs;
    }

    public int retrieveItemCount()
    {
        return AudioService.getNumberOfSongsForPlaylist(new Long(getInternalObjectId()), this.accessGroup);
    }
}


/* Location:           C:\Users\Main\Downloads\serviio.jar
* Qualified Name:     org.serviio.upnp.service.contentdirectory.command.audio.ListSongsForPlaylistCommand
