...
public class ListAlbumsForAlbumArtistCommand
  : AbstractAlbumsRetrievalCommand
{
  ...
  {
    List!(MusicAlbum) albums = AudioService.getListOfAlbumsForAlbumArtist(new Long(getInternalObjectId()), this.startIndex, this.count);
    return albums;
  }
