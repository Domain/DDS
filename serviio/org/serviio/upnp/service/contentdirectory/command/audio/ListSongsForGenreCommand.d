...
public class ListSongsForGenreCommand
  : AbstractSongsRetrievalCommand
{
  ...
  {
    List!(MusicTrack) songs = AudioService.getListOfSongsForGenre(new Long(getInternalObjectId()), this.accessGroup, this.startIndex, this.count);
    return songs;
  }
  
  public int retrieveItemCount()
  {
    return AudioService.getNumberOfSongsForGenre(new Long(getInternalObjectId()), this.accessGroup);
  }
}
