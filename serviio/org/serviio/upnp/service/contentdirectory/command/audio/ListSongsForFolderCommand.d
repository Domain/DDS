...
public class ListSongsForFolderCommand : AbstractSongsRetrievalCommand
{
    ...
    {
        List!(MusicTrack) songs = AudioService.getListOfSongsForFolder(new Long(getInternalObjectId()), this.accessGroup, this.startIndex, this.count);
        return songs;
    }

    public int retrieveItemCount()
    {
        return AudioService.getNumberOfSongsForFolder(new Long(getInternalObjectId()), this.accessGroup);
    }

    override protected String getItemTitle(MusicTrack song, bool markedItem)
    {
