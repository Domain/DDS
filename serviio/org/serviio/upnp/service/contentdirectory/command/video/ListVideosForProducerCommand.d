...
public class ListVideosForProducerCommand : AbstractVideosRetrievalCommand
{
    ...
    {
        List!(Video) videos = VideoService.getListOfVideosForPerson(new Long(getInternalObjectId()), Person.RoleType.PRODUCER, accessGroup, startIndex, count);
        return videos;
    }

    public int retrieveItemCount()
    {
        return VideoService.getNumberOfVideosForPerson(new Long(getInternalObjectId()), Person.RoleType.PRODUCER, accessGroup);
    }
}
