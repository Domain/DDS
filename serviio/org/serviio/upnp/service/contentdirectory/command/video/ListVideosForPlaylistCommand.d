...
public class ListVideosForPlaylistCommand
  : AbstractVideosRetrievalCommand
{
  ...
  {
    List!(Video) videos = VideoService.getListOfVideosForPlaylist(new Long(getInternalObjectId()), this.accessGroup, this.startIndex, this.count);
    return videos;
  }
  
  public int retrieveItemCount()
  {
    return VideoService.getNumberOfVideosForPlaylist(new Long(getInternalObjectId()), this.accessGroup);
  }
}
