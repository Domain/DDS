...
public class ListLastAddedVideosCommand : AbstractVideosRetrievalCommand
{
    ...
    {
        List!(Video) videos = VideoService.getListOfLastAddedVideos(Configuration.getNumberOfFilesForDynamicCategories().intValue(), accessGroup, startIndex, count);
        return videos;
    }

    public int retrieveItemCount()
    {
        return VideoService.getNumberOfLastAddedVideos(Configuration.getNumberOfFilesForDynamicCategories().intValue(), accessGroup);
    }
}
