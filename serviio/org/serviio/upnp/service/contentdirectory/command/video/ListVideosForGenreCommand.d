...
public class ListVideosForGenreCommand
  : AbstractVideosRetrievalCommand
{
  ...
  {
    List!(Video) videos = VideoService.getListOfVideosForGenre(new Long(getInternalObjectId()), this.accessGroup, this.startIndex, this.count);
    return videos;
  }
  
  public int retrieveItemCount()
  {
    return VideoService.getNumberOfVideosForGenre(new Long(getInternalObjectId()), this.accessGroup);
  }
}
