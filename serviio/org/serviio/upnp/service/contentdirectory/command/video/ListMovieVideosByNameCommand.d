module org.serviio.upnp.service.contentdirectory.command.video.ListMovieVideosByNameCommand;
...
public class ListMovieVideosByNameCommand : AbstractVideosRetrievalCommand
{
    ...
    {
        List!(Video) videos = VideoService.getListOfMovieVideos(this.accessGroup, this.startIndex, this.count);
        return videos;
    }

    public int retrieveItemCount()
    {
        return VideoService.getNumberOfMovieVideos(this.accessGroup);
    }
}


/* Location:           C:\Users\Main\Downloads\serviio.jar
* Qualified Name:     org.serviio.upnp.service.contentdirectory.command.video.ListMovieVideosByNameCommand
