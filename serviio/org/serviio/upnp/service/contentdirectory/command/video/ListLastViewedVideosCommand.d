...
public class ListLastViewedVideosCommand
  : AbstractVideosRetrievalCommand
{
  ...
  {
    List!(Video) videos = VideoService.getListOfLastViewedVideos(Configuration.getNumberOfFilesForDynamicCategories().intValue(), this.accessGroup, this.startIndex, this.count);
    return videos;
  }
  
  public int retrieveItemCount()
  {
    return VideoService.getNumberOfLastViewedVideos(Configuration.getNumberOfFilesForDynamicCategories().intValue(), this.accessGroup);
  }
}
