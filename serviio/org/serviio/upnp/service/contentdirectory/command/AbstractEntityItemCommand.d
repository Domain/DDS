...
public abstract class AbstractEntityItemCommand(E : PersistedEntity) : AbstractCommand!(Item)
{
	...
	override protected List!(Item) retrieveList()
	{
	...
	override protected Item retrieveSingleItem()
	{
		...
		throw new ObjectNotFoundException(String_format("Object with id %s not found in CDS", cast(Object[])[ objectId ]));
	}
