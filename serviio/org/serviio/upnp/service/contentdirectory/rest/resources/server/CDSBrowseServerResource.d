...
public class CDSBrowseServerResource : AbstractRestrictedCDSServerResource , CDSBrowseResource
{
    ...
    static this()
    {
        log = LoggerFactory.getLogger!(CDSBrowseServerResource)();
    }
    ...
    {
        Set!(DeliveryQuality.QualityType) qualities = new HashSet!(DeliveryQuality.QualityType)();
    ...
    private List!(Resource) getSuitableResources(Item item)
    {
        ...
        Set!(DeliveryQuality.QualityType) foundQualities = new HashSet!(DeliveryQuality.QualityType)();
