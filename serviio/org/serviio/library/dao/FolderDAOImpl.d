...
public class FolderDAOImpl : AbstractAccessibleDao, FolderDAO
{
    ...
    public long create(Folder newInstance)
    {
        ...
        log.debug_(String_format("Creating a new Folder (name = %s)", cast(Object[])[ newInstance.getName() ]));
        Connection con = null;
        try
        {
            ...
            throw new PersistenceException(String_format("Cannot create Folder with name %s", cast(Object[])[ newInstance.getName() ]), e);
        } finally {
    ...
    {
        log.debug_(String_format("Deleting a Folder (id = %s)", cast(Object[])[ id ]));
        try
        {
        ...
        {
            throw new PersistenceException(String_format("Cannot delete Folder with id = %s", cast(Object[])[ id ]), e);
        }
    }

    public Folder read(Long id)
    {
        log.debug_(String_format("Reading a Folder (id = %s)", cast(Object[])[ id ]));
        Connection con = null;
        ...
        try {
            ...
            throw new PersistenceException(String_format("Cannot read Folder with id = %s", cast(Object[])[ id ]), e);
        } finally {
    ...
    public Long getOrCreateFolder(File folderPath, Long repositoryId)
    {
        ...
        if (folderPath is null)
        {
            ...
            log.debug_(String_format("Looking for folder hierarchy %s", cast(Object[])[ folderPath.getPath() ]));
        ...
        try {
            ...
            throw new PersistenceException(String_format("Cannot create file path for Folder %s", cast(Object[])[ folderPath.getPath() ]), e);
        } finally {
            JdbcUtils.closeStatement(ps);
            DatabaseManager.releaseConnection(con);
        }
    ...
    {
        log.debug_(String_format("Getting number of media items in folder %s", cast(Object[])[ folderId ]));
        Connection con = null;
        PreparedStatement ps = null;
        try {
            con = DatabaseManager.getConnection();
            ...
            throw new PersistenceException(String_format("Cannot get number of media items in folder: %s ", cast(Object[])[ folderId ]), e);
        } finally {
            JdbcUtils.closeStatement(ps);
            DatabaseManager.releaseConnection(con);
        }
    ...
    {
        log.debug_(String_format("Getting number of sub-Folders in folder %s [%s]", cast(Object[])[ folderId, accessGroup ]));
        Connection con = null;
        PreparedStatement ps = null;
        try {
            con = DatabaseManager.getConnection();
            ...
            throw new PersistenceException(String_format("Cannot get number of sub-Folders in folder: %s ", cast(Object[])[ folderId ]), e);
        } finally {
            JdbcUtils.closeStatement(ps);
            DatabaseManager.releaseConnection(con);
        }
    ...
    {
        log.debug_(String_format("Getting number of %s sub-folders and media items in folder %s (filter: %s) [%s]", cast(Object[])[ fileType, folderId is null ? "'root'" : folderId, objectType, accessGroup ]));
        ...
        try {
            ...
            throw new PersistenceException(String_format("Cannot get number of %s media items in folder: %s ", cast(Object[])[ fileType, folderId ]), e);
        } finally {
            JdbcUtils.closeStatement(ps);
            DatabaseManager.releaseConnection(con);
        }
    ...
    {
        log.debug_(String_format("Retrieving list of leaf folders (from=%s, count=%s) [%s]", cast(Object[])[ Integer.valueOf(startingIndex), Integer.valueOf(requestedCount), accessGroup ]));
        Connection con = null;
        PreparedStatement ps = null;
        try {
            con = DatabaseManager.getConnection();
    ...
    {
        log.debug_(String_format("Retrieving number of leaf folders [%s]", cast(Object[])[ accessGroup ]));
        Connection con = null;
        PreparedStatement ps = null;
        try {
            con = DatabaseManager.getConnection();
    ...
    {
        log.debug_(String_format("Getting list of sub-Folders in folder %s (from=%s, count=%s) [%s]", cast(Object[])[ folderId, Integer.valueOf(startingIndex), Integer.valueOf(requestedCount), accessGroup ]));
        Connection con = null;
        PreparedStatement ps = null;
        try {
            con = DatabaseManager.getConnection();
            ...
            throw new PersistenceException(String_format("Cannot get list of sub-Folders in folder: %s ", cast(Object[])[ folderId ]), e);
        } finally {
            JdbcUtils.closeStatement(ps);
            DatabaseManager.releaseConnection(con);
        }
    ...
    protected Long findFolderById(Connection con, String name, Long repositoryId, Long parentFolderId)
    {
        ...
        try {
            ...
            throw new PersistenceException(String_format("Cannot read Folder with name = %s", cast(Object[])[ name ]), e);
        } finally {
            JdbcUtils.closeStatement(ps);
        }
    }
