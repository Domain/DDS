...
public class ImageDAOImpl : AbstractSortableItemDao, ImageDAO
{
    ...
    static this()
    {
        log = LoggerFactory.getLogger!(ImageDAOImpl);
    }
    ...
    public long create(Image newInstance)
    {
        ...
        log.debug_(java.lang.String.format("Creating a new Image (name = %s)", cast(Object[])[ newInstance.getTitle() ]));
        Connection con = null;
        ...
        try
        {
            ...
            JdbcUtils.setStringValueOnStatement(ps, 17, newInstance.getChromaSubsampling() != SamplingMode.INVALID ? newInstance.getChromaSubsampling().toString() : null);
        ...
        {
            throw new PersistenceException(java.lang.String.format("Cannot create Image with name %s", cast(Object[])[ newInstance.getTitle() ]), e);
        }
        finally
        {
    ...
    {
        log.debug_(java.lang.String.format("Deleting an Image (id = %s)", cast(Object[])[ id ]));
        Connection con = null;
        PreparedStatement ps = null;
        try
        {
        ...
        {
            throw new PersistenceException(java.lang.String.format("Cannot delete Image with id = %s", cast(Object[])[ id ]), e);
        }
        finally
        {
            JdbcUtils.closeStatement(ps);
    ...
    {
        log.debug_(java.lang.String.format("Reading an Image (id = %s)", cast(Object[])[ id ]));
        Connection con = null;
        PreparedStatement ps = null;
        try
        {
        ...
        {
            throw new PersistenceException(java.lang.String.format("Cannot read Image with id = %s", cast(Object[])[ id ]), e);
        }
        finally
        {
            JdbcUtils.closeStatement(ps);
    ...
    public void update(Image transientObject)
    {
        ...
        log.debug_(java.lang.String.format("Updating Image (id = %s)", cast(Object[])[ transientObject.getId() ]));
        Connection con = null;
        PreparedStatement ps = null;
        try
        {
            ...
            JdbcUtils.setStringValueOnStatement(ps, 16, transientObject.getChromaSubsampling() != SamplingMode.INVALID ? transientObject.getChromaSubsampling().toString() : null);
        ...
        {
            throw new PersistenceException(java.lang.String.format("Cannot update Image with id %s", cast(Object[])[ transientObject.getId() ]), e);
        }
        finally
        {
            JdbcUtils.closeStatement(ps);
    ...
    {
        log.debug_(java.lang.String.format("Retrieving list of images for folder %s (from=%s, count=%s) [%s]", cast(Object[])[ folderId.toString(), Integer.valueOf(startingIndex).toString(), Integer.valueOf(requestedCount).toString(), accessGroup.toString() ]));
        Connection con = null;
        PreparedStatement ps = null;
        try
        {
            con = DatabaseManager.getConnection();
            ps = con.prepareStatement("SELECT media_item.id as id, title, sort_title, file_size, file_name, folder_id, container, creation_date, description, width, height, color_depth, cover_image_id, last_viewed_date, number_viewed, rotation, file_path, media_item.repository_id as repository_id, subsampling, dirty FROM media_item " ~ accessGroupTable(accessGroup) ~ "WHERE file_type = ? AND folder_id = ? " ~ accessGroupConditionForMediaItem(accessGroup) ~ "ORDER BY lower(file_name) " ~ "OFFSET " ~ startingIndex.toString() ~ " ROWS FETCH FIRST " ~ requestedCount.toString() ~ " ROWS ONLY");
        ...
        {
            throw new PersistenceException(java.lang.String.format("Cannot read list of images for folder %s", cast(Object[])[ folderId ]), e);
        }
        finally
        {
            JdbcUtils.closeStatement(ps);
    ...
    {
        log.debug_(java.lang.String.format("Retrieving number of images for folder %s [%s]", cast(Object[])[ folderId.toString(), accessGroup.toString() ]));
        Connection con = null;
        PreparedStatement ps = null;
        try
        {
        ...
        {
            throw new PersistenceException(java.lang.String.format("Cannot read number of images for folder %s", cast(Object[])[ folderId ]), e);
        }
        finally
        {
            JdbcUtils.closeStatement(ps);
    ...
    {
        log.debug_(java.lang.String.format("Retrieving list of images for Playlist %s (from=%s, count=%s) [%s]", cast(Object[])[ playlistId.toString(), Integer.valueOf(startingIndex).toString(), Integer.valueOf(requestedCount).toString(), accessGroup.toString() ]));
        Connection con = null;
        PreparedStatement ps = null;
        try
        {
        ...
        {
            throw new PersistenceException(java.lang.String.format("Cannot read list of images for playlist %s", cast(Object[])[ playlistId ]), e);
        }
        finally
        {
            JdbcUtils.closeStatement(ps);
    ...
    {
        log.debug_(java.lang.String.format("Retrieving number of images for playlist %s [%s]", cast(Object[])[ playlistId.toString(), accessGroup.toString() ]));
        Connection con = null;
        PreparedStatement ps = null;
        try
        {
        ...
        {
            throw new PersistenceException(java.lang.String.format("Cannot read number of images for playlist %s", cast(Object[])[ playlistId ]), e);
        }
        finally
        {
            JdbcUtils.closeStatement(ps);
    ...
    {
        log.debug_(java.lang.String.format("Retrieving list of images' years (from=%s, count=%s) [%s]", cast(Object[])[ Integer.valueOf(startingIndex).toString(), Integer.valueOf(requestedCount).toString(), accessGroup.toString() ]));
        Connection con = null;
        PreparedStatement ps = null;
        try
        {
            con = DatabaseManager.getConnection();
            ps = con.prepareStatement("SELECT distinct YEAR(creation_date) as creation_year FROM media_item " ~ accessGroupTable(accessGroup) ~ "WHERE file_type = ? " ~ accessGroupConditionForMediaItem(accessGroup) ~ "ORDER BY creation_year desc " ~ "OFFSET " ~ startingIndex.toString() ~ " ROWS FETCH FIRST " ~ requestedCount.toString() ~ " ROWS ONLY");
    ...
    {
        log.debug_(java.lang.String.format("Retrieving number of images' years [%s]", cast(Object[])[ accessGroup ]));
        Connection con = null;
        PreparedStatement ps = null;
        try
        {
    ...
    {
        log.debug_(java.lang.String.format("Retrieving list of images for year %s (from=%s, count=%s) [%s]", cast(Object[])[ year.toString(), Integer.valueOf(startingIndex).toString(), Integer.valueOf(requestedCount).toString(), accessGroup.toString() ]));
        Connection con = null;
        PreparedStatement ps = null;
        try
        {
            con = DatabaseManager.getConnection();
            ps = con.prepareStatement("SELECT media_item.id as id, title, sort_title, file_size, file_name, folder_id, container, creation_date, description, width, height, color_depth, cover_image_id, last_viewed_date, number_viewed, rotation, file_path, media_item.repository_id as repository_id, subsampling, dirty FROM media_item " ~ accessGroupTable(accessGroup) ~ "WHERE file_type = ? and YEAR(creation_date) = ? " ~ accessGroupConditionForMediaItem(accessGroup) ~ "ORDER BY creation_date, lower(sort_title) " ~ "OFFSET " ~ startingIndex.toString() ~ " ROWS FETCH FIRST " ~ requestedCount.toString() ~ " ROWS ONLY");
        ...
        {
            throw new PersistenceException(java.lang.String.format("Cannot read list of images for year %s", cast(Object[])[ year ]), e);
        }
        finally
        {
            JdbcUtils.closeStatement(ps);
    ...
    {
        log.debug_(java.lang.String.format("Retrieving number of images for year %s [%s]", cast(Object[])[ year.toString(), accessGroup.toString() ]));
        Connection con = null;
        PreparedStatement ps = null;
        try
        {
        ...
        {
            throw new PersistenceException(java.lang.String.format("Cannot read number of images for year %s", cast(Object[])[ year ]), e);
        }
        finally
        {
            JdbcUtils.closeStatement(ps);
    ...
    {
        log.debug_(java.lang.String.format("Retrieving list of creation date months for year %s (from=%s, count=%s) [%s]", cast(Object[])[ year.toString(), Integer.valueOf(startingIndex).toString(), Integer.valueOf(requestedCount).toString(), accessGroup.toString() ]));
        Connection con = null;
        PreparedStatement ps = null;
        try
        {
            con = DatabaseManager.getConnection();
            ps = con.prepareStatement("SELECT distinct MONTH(creation_date) as creation_month FROM media_item " ~ accessGroupTable(accessGroup) ~ "WHERE file_type = ? and YEAR(creation_date) = ? " ~ accessGroupConditionForMediaItem(accessGroup) ~ "ORDER BY creation_month " ~ "OFFSET " ~ startingIndex.toString() ~ " ROWS FETCH FIRST " ~ requestedCount.toString() ~ " ROWS ONLY");
        ...
        {
            throw new PersistenceException(java.lang.String.format("Cannot read list of creation date months for year %s", cast(Object[])[ year ]), e);
        }
        finally
        {
            JdbcUtils.closeStatement(ps);
    ...
    {
        log.debug_(java.lang.String.format("Retrieving number of  creation date months for year %s [%s]", cast(Object[])[ year.toString(), accessGroup.toString() ]));
        Connection con = null;
        PreparedStatement ps = null;
        try
        {
        ...
        {
            throw new PersistenceException(java.lang.String.format("Cannot read number of creation date months for year %s", cast(Object[])[ year ]), e);
        }
        finally
        {
            JdbcUtils.closeStatement(ps);
    ...
    {
        log.debug_(java.lang.String.format("Retrieving list of images for year %s and month %s (from=%s, count=%s) [%s]", cast(Object[])[ year.toString(), month.toString(), Integer.valueOf(startingIndex).toString(), Integer.valueOf(requestedCount).toString(), accessGroup.toString() ]));
        Connection con = null;
        PreparedStatement ps = null;
        try
        {
            con = DatabaseManager.getConnection();
            ps = con.prepareStatement("SELECT media_item.id as id, title, sort_title, file_size, file_name, folder_id, container, creation_date, description, width, height, color_depth, cover_image_id, last_viewed_date, number_viewed, rotation, file_path, media_item.repository_id as repository_id, subsampling, dirty FROM media_item " ~ accessGroupTable(accessGroup) ~ "WHERE file_type = ? and YEAR(creation_date) = ? and MONTH(creation_date) = ? " ~ accessGroupConditionForMediaItem(accessGroup) ~ "ORDER BY creation_date, lower(sort_title) " ~ "OFFSET " ~ startingIndex.toString() ~ " ROWS FETCH FIRST " ~ requestedCount.toString() ~ " ROWS ONLY");
        ...
        {
            throw new PersistenceException(java.lang.String.format("Cannot read list of images for year %s and month %s", cast(Object[])[ year, month ]), e);
        }
        finally
        {
            JdbcUtils.closeStatement(ps);
    ...
    {
        log.debug_(java.lang.String.format("Retrieving number of images for year %s and month %s [%s]", cast(Object[])[ year.toString(), month.toString(), accessGroup.toString() ]));
        Connection con = null;
        PreparedStatement ps = null;
        try
        {
        ...
        {
            throw new PersistenceException(java.lang.String.format("Cannot read number of images for year %s and month %s", cast(Object[])[ year, month ]), e);
        }
        finally
        {
            JdbcUtils.closeStatement(ps);
    ...
    {
        log.debug_(java.lang.String.format("Retrieving list of all images (from=%s, count=%s) [%s]", cast(Object[])[ Integer.valueOf(startingIndex).toString(), Integer.valueOf(requestedCount).toString(), accessGroup.toString() ]));
        Connection con = null;
        PreparedStatement ps = null;
        try
        {
            con = DatabaseManager.getConnection();
            ps = con.prepareStatement("SELECT media_item.id as id, title, sort_title, file_size, file_name, folder_id, container, creation_date, description, width, height, color_depth, cover_image_id, last_viewed_date, number_viewed, rotation, file_path, media_item.repository_id as repository_id, subsampling, dirty FROM media_item " ~ accessGroupTable(accessGroup) ~ "WHERE file_type = ? " ~ accessGroupConditionForMediaItem(accessGroup) ~ "ORDER BY creation_date, lower(file_name) " ~ "OFFSET " ~ startingIndex.toString() ~ " ROWS FETCH FIRST " ~ requestedCount.toString() ~ " ROWS ONLY");
    ...
    {
        log.debug_(java.lang.String.format("Retrieving number of all images [%s]", cast(Object[])[ accessGroup ]));
        Connection con = null;
        PreparedStatement ps = null;
        try
        {
