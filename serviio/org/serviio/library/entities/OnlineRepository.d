...
public class OnlineRepository : PersistedEntity
{
    ...
    override public String toString()
    {
        ...
        builder.append("OnlineRepository [repositoryUrl=").append(this.repositoryUrl)
            ...
            .append(", repoType=").append(this.repoType)
            .append(", thumbnailUrl=").append(this.thumbnailUrl)
            .append(", repositoryName=").append(this.repositoryName)
            .append(", enabled=").append(this.enabled)
            .append(", accessGroupIds=").append(this.accessGroupIds)
