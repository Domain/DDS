...
public class OnlineRepositoryService : Service
{
    private static Logger log;

    static this()
    {
        log = LoggerFactory.getLogger!(OnlineRepositoryService);
    }
    ...
    public static void saveRepositories(List!(OnlineRepository) repositories)
    {
        ...
        List!(OnlineRepository) repsToRemove = new ArrayList();
        ...
        foreach (OnlineRepository existingRepository ; existingRepositories) {
            ...
            {
                log.debug_(java.lang.String.format("Will remove OnlineRepository: %s", cast(Object[])[ existingRepository.toString() ]));
