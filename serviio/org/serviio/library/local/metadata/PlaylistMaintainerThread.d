...
public class PlaylistMaintainerThread : AbstractLibraryCheckerThread
{
    ...
    {
        log.debug_(java.lang.String.format("Playlist %s has unresolved items, checking if they are in the library now", cast(Object[])[ playlist.getTitle() ]));
        ...
        foreach (PlaylistItem pi ; parsedPlaylist.getItems()) {
            ...
            {
                log.debug_(java.lang.String.format("Found playlist item that has not been added yet: %s", cast(Object[])[ pi.getPath() ]));
                ...
                {
                    log.debug_(java.lang.String.format("Item '%s' cannot be resolved to an entity in the Serviio library, will try again later", cast(Object[])[ pi.getPath() ]));
    ...
    {
        log.debug_(java.lang.String.format("Playlist %s has changed, updating the library", cast(Object[])[ playlist.getTitle() ]));
        ParsedPlaylist parsedPlaylist = parsePlaylst(playlist.getFilePath());
