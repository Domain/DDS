...
public class AudioService : Service
{
    ...
    public static void addMusicTrackToLibrary(AudioMetadata metadata, Repository repository)
    {
        if (metadata !is null)
        {
            ...
            MusicTrack track = new MusicTrack(metadata.getTitle(), metadata.getContainer(), new File(metadata.getFilePath()).getName(), metadata.getFilePath(), Long.valueOf(metadata.getFileSize()), cast(Long)folderHierarchy.getValueA(), repository.getId(), metadata.getDate());
