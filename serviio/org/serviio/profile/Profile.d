...
{
    private static immutable Logger log = LoggerFactory.getLogger!(Profile)();
    ...
    public static const String DETECTION_FIELD_MODEL_NUMBER = "ModelNumber";
    public static const String DETECTION_FIELD_PRODUCT_CODE = "ProductCode";
    public static const String DETECTION_FIELD_MANUFACTURER = "Manufacturer";
    private String id;
    private String name;
    ...
    {
        protocolInfo = new LinkedHashMap!(MediaFormatProfile, ProtocolInfo)();
        this.id = id;
        this.name = name;
