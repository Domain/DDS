...
public class AudioContainer
{
    ...
    {
        if (is(o : AudioContainer))
        {
            return this.audioContainer == cast(AudioContainer)o.audioContainer;
        }
        else if (is(o : AudioContainerEnum))
        {
            return this.audioContainer == o;
        }
        return false;
    }

    public bool opEquals(AudioContainerEnum rhs)
    {
        return this.audioContainer == rhs;
    }
}
