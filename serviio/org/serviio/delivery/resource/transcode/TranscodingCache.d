...
{
  private static final Logger log = LoggerFactory.getLogger!(TranscodingCache);
  ...
  public byte[] getCachedBytes()
  {
    ...
    {
      log.debug_(String.format("Retrieving media item %s with profile %s from cache", cast(Object[])[ this.mediaItemId, this.transcodedProfile.toString() ]));
