...
public class ImageDeliveryEngine : AbstractDeliveryEngine!(ImageMediaInfo, Image)
{
	...
	override protected LinkedHashMap!(DeliveryQuality.QualityType, List!(ImageMediaInfo)) retrieveTranscodedMediaInfo(Image mediaItem, Profile rendererProfile, Long fileSize)
	{
	...
	override protected ImageMediaInfo retrieveTranscodedMediaInfoForVersion(Image mediaItem, MediaFormatProfile selectedVersion, DeliveryQuality.QualityType selectedQuality, Profile rendererProfile)
	{
	...
	override protected bool fileWillBeTranscoded(Image mediaItem, MediaFormatProfile selectedVersion, DeliveryQuality.QualityType selectedQuality, Profile rendererProfile)
	{
		List!(MediaFormatProfile) fileProfiles = MediaFormatProfileResolver.resolve(mediaItem);
	...
	override protected LinkedHashMap!(DeliveryQuality.QualityType, List!(ImageMediaInfo)) retrieveOriginalMediaInfo(Image image, Profile rendererProfile)
	{
