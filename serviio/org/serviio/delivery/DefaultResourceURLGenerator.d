  ...
  : ResourceURLGenerator
{
  ...
  public String getGeneratedURL(HostInfo hostInfo, Resource.ResourceType resourceType, Long resourceId, MediaFormatProfile version, Integer protocolInfoIndex, DeliveryQuality.QualityType quality)
  {
    validate(resourceType, resourceId, version, protocolInfoIndex, quality);
    ...
    if (Resource.ResourceType.SUBTITLE == resourceType) {
      file.append(".srt");
    } else if ((Resource.ResourceType.MANIFEST == resourceType) || ((version !is null) && (version.isManifestFormat()))) {
      file.append(".m3u8");
    }
  ...
  private void validate(Resource.ResourceType resourceType, Long resourceId, MediaFormatProfile version, Integer protocolInfoIndex, DeliveryQuality.QualityType quality)
  {
    if ((resourceId is null) || (resourceType is null) || ((resourceType == Resource.ResourceType.MEDIA_ITEM) && ((version is null) || (quality is null) || (protocolInfoIndex is null)))) {
